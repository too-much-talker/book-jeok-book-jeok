...
public class OpenBooklogDto {
    ...
    @QueryProjection
    public OpenBooklogDto(Long booklogSeq, String nickname, String title, String content, Integer likes, LocalDateTime createdDate, String imgUrl) {
