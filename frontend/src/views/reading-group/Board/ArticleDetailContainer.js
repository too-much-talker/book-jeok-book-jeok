...
function ArticleDetailContainer(){
    ...
    function getArticle(){ ////useParam.seq에서 seq 글자 이거 수정되면 꼭 같이 수정해야함
        ...
        .then(function (response){
            ...
            setCreatedDate(response.data.data.readingGroupArticle.createdDate);
    ...
    return(
        <>
            <ArticleDetailPresenter comments={comments} title={title} content={content} nickname={nickname} createdDate={createdDate} views={views}></ArticleDetailPresenter>
        </>
    );
}
