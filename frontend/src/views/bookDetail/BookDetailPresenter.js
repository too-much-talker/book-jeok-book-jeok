        ...
        <ReviewBookLog>
          <BookReview>
            <ReviewHeader>
              ...
              <Buttons>
                <MyReviewButton onClick={handleMyModalOpen}>
                  내 책리뷰
                </MyReviewButton>
                <MyModalContainer
                  isOpen={MyModalOpen}
                  onCancel={handleMyModalClose}
                  ...
                  url={url}
                ></MyModalContainer>
                <WriteReviewButton onClick={handleWriteModalOpen}>
                  책리뷰 작성하기
                </WriteReviewButton>
                <WriteModalContainer
                  isOpen={WriteModalOpen}
                  onCancel={handleWriteModalClose}
                  user={user}
                  jwtToken={jwtToken}
                  seq={seq}
                  url={url}
